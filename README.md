...
## Observations
  ...
  -------------------------------------- --------------------------------
  Logistic Regression                    Strong performance due to
                                         near-linear separability of the
                                         dataset.

  Decision Tree                          Lower generalization
                                         performance; may suffer from
                                         overfitting.

  kNN                                    Good performance with proper
                                         scaling; slightly lower recall.

  Naive Bayes                            High AUC but lower overall
                                         metrics due to feature
                                         independence assumption.

  Random Forest                          Excellent overall performance
                                         with perfect precision and
                                         strong MCC.

  XGBoost                                Matched Random Forest accuracy
                                         and achieved highest AUC; robust
                                         ensemble method.
  -----------------------------------------------------------------------
